...
[`@aws-sdk/client-kinesis-analytics`](https://www.npmjs.com/package/@aws-sdk/client-kinesis-analytics/v/3.40.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics@3.40.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-9L0FXPda1fS8TE8choaIacim7koOBboDAPnWk3ORqxk7TnAsG2jaOYBQqbAMzyBP
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-kinesis-analytics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics@3.40.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-kinesis-analytics@3.40.0/index.min.mjs": "sha384-9L0FXPda1fS8TE8choaIacim7koOBboDAPnWk3ORqxk7TnAsG2jaOYBQqbAMzyBP"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-kinesis-analytics/blob/refs/tags/3.40.0/LICENSE
```
